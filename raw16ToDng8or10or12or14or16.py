...
width = 1920
height = 1080
bpp= 16   #输出位深只有8、10、12、14和16这5种数值可选  Only 8, 10, 12, 14 and 16 are available
...
rawFile = r'..\extras\RAW_00019.raw16'          #16位拜尔图像文件路径
rf = open(rawFile, mode='rb')
rawData = struct.unpack("H"*numPixels,rf.read(2*numPixels))    #struct.unpack("H"*numPixels,rf.read(2*numPixels))
...
# save to dng file.
RAW2DNG().convert(rawImage, tags=t, filename="RAW_00019", path="")
